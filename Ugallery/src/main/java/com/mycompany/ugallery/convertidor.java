...
import static com.mycompany.ugallery.Menu.listaUsers;
import static com.mycompany.ugallery.biblioteca.listaCategorias;
...
public class convertidor extends javax.swing.JFrame implements Runnable{
    ...
    public convertidor() {
        ...
        for (int i = 0; i < listaUsers.size(); i++) {
            jComboBox1.addItem(listaUsers.get(i).getNombre());
        }
    }
    ...
    private void initComponents() {
        ...
        jRadioButton3.setText("RGB Sepia");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("Modificar imagen");

        buttonGroup1.add(jRadioButton5);
        jRadioButton5.setText("B&W");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        convertidor hilo = new convertidor(jTextArea1);
    ...
    public void run() {
        while (true) {            
           try {
               listaCategorias.get(0).getListImagenes().printListNext(indice, jTextArea1);
                indice++;
